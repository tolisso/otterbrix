...
using namespace components::collection::operators::merge;
...
TEST_CASE("operator_merge::and") {
    ...
    auto cond2 =
        make_compare_expression(&resource, compare_type::lte, key("count", side_t::left), core::parameter_id_t(2));
    operator_and_t op_and(d(collection), logical_plan::limit_t::unlimit());
    op_and.set_children(
        boost::intrusive_ptr(
            new full_scan(d(collection), predicates::create_predicate(cond1), logical_plan::limit_t::unlimit())),
        boost::intrusive_ptr(
...
TEST_CASE("operator_merge::or") {
    ...
    auto cond2 =
        make_compare_expression(&resource, compare_type::gt, key("count", side_t::left), core::parameter_id_t(2));
...
TEST_CASE("operator_merge::complex") {
    ...
    auto cond_or2 =
        make_compare_expression(&resource, compare_type::gt, key("count", side_t::left), core::parameter_id_t(2));
    auto cond_and1 =
        make_compare_expression(&resource, compare_type::gt, key("count", side_t::left), core::parameter_id_t(3));
    auto cond_and2 =
        make_compare_expression(&resource, compare_type::lte, key("count", side_t::left), core::parameter_id_t(4));
    ...
    auto op_and = create_operator_merge(d(collection), compare_type::union_and, logical_plan::limit_t::unlimit());
    op_or->set_children(
        boost::intrusive_ptr(
            new full_scan(d(collection), predicates::create_predicate(cond_or1), logical_plan::limit_t::unlimit())),
        boost::intrusive_ptr(
            new full_scan(d(collection), predicates::create_predicate(cond_or2), logical_plan::limit_t::unlimit())));
    op_and->set_children(
        boost::intrusive_ptr(
            new full_scan(d(collection), predicates::create_predicate(cond_and1), logical_plan::limit_t::unlimit())),
        boost::intrusive_ptr(
