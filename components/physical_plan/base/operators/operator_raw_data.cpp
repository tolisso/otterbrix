...
namespace components::base::operators {
    ...
    operator_raw_data_t::operator_raw_data_t(std::pmr::vector<document::document_ptr>&& documents)
    ...
    operator_raw_data_t::operator_raw_data_t(const std::pmr::vector<document::document_ptr>& documents)
        : read_only_operator_t(nullptr, operator_type::raw_data) {
        output_ = make_operator_data(documents.get_allocator().resource());
