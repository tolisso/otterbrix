...
namespace components::base::operators {
    ...
    public:
        explicit operator_raw_data_t(std::pmr::vector<document::document_ptr>&& documents);
        explicit operator_raw_data_t(const std::pmr::vector<document::document_ptr>& documents);
